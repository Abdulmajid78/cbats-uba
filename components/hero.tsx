...
const Hero = () => {
	...
	const placeholderText: PlaceholderText[] = [
		...
		},
		{
			...
			className:
				'md:text-4xl text-center xl:px-[20px] sm:text-[44px] text-xl text-gray-800',
		},
		{
			type: 'heading2',
			text: t("ConferenceWebsite"),
			className:
				'w-full sm:max-w-[1200px] max-w-[400px] mx-auto sm:text-lg text-base text-center text-gray-600 !leading-6 mt-2 lg:px-[20px]',
			color: '#4B5563',
		},
		{
			type: 'heading2',
			...
			className:
				'w-full sm:max-w-[1000px] max-w-[400px] mx-auto sm:text-lg text-base text-center text-gray-600 !leading-6 lg:px-[20px]',
			color: '#4B5563',
		},
	]
